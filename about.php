...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <?php 
	...
	?>
	 ...
	 <div class="the_end">
	 Надявам се сме ви помогнали в търсенето на идеалната половинка! 
	 А дали ще бъдете заедно за цял живот или просто ще се забавлявате зависи изцяло от вас! </div>
	 <div class="the_end" style="font-size:15px;margin-top:180px;">Забележка!!! Този сайт не е завършен на този етап! Предстои да бъдат добавена възможността всеки потребител да качи профилна снимка и
	 да има собствен профил.</div>
	 </div>
    </div>
